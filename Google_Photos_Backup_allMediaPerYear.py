...
# MAIN SCRIPT #
###############
# Failed at [ 8 / 9 ] Photo [ 20180425_124930.jpg ] will be downloaded to  /media/nas/GG-Google/2018/4
...
while oneMoreSearch:
    ...
    allMedia = service.mediaItems().search(
        body={"filters": {"dateFilter":
            {"ranges": [
                {"startDate": {"day": 1, "month": 1, "year": 2014},
                 "endDate": {"day": 31, "month": 4, "year": 2018}}]}},
            "pageSize": 10, "pageToken": myNextPageToken}).execute()
