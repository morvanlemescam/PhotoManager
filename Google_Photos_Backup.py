...
print(dfAlbums.to_markdown())

download_album_id = dfAlbums[dfAlbums['title'] == 'Album De Test']['id'].to_string(index=False).strip()
...
media_files = service.mediaItems().search(body={'albumId': download_album_id}).execute()['mediaItems']

destination_folder = r'./PhotosBackup'
